"""Model config to train second block of a stacked autoencoder."""

from configs import layer_0
import nets
...
def _get_prev_model():
    ...
    checkpoint_path = (
        '/braintree/home/nwatters/models/cornet/sae_logs/noise_0_layer_0/0/'
        'latest_checkpoint.pth.tar'
    )
    prev_model = layer_0.get_model()
